...
namespace CleanArchitecture.FrameworkAndDrivers.Migrations
{
    ...
    [Migration("20241021225948_AddUserProfileRoleRelationship")]
    partial class AddUserProfileRoleRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Entities.Users.UserAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CleanArchitecture.Entities.Users.UserAccount", b =>
                {
                    b.HasOne("CleanArchitecture.Entities.Users.Employee", "Employee")
                        .WithOne("UserAccount")
                        .HasForeignKey("CleanArchitecture.Entities.Users.UserAccount", "EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CleanArchitecture.Entities.Users.UserProfile", b =>
                {
                    b.HasOne("CleanArchitecture.Entities.Users.Role", "Role")
                        .WithOne("UserProfile")
                        .HasForeignKey("CleanArchitecture.Entities.Users.UserProfile", "RoleId");
